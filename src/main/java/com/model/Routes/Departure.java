...
public class Departure {
    ...
    {
        return "DeparturePojo [delay = "+delay+",station = "+station+", stationinfo = "+stationinfo+",time = "+time+",vehicle = "+vehicle+",  platform = "+platform+", platforminfo = "+platforminfo+", canceled = "+canceled+",  direction = "+direction+", departureConnection = "+departureConnection+",  occupancy = "+occupancy+"]";
    }
}
